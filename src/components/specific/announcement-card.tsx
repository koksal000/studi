    ...
    if (isImage) {
        return (
            <div ref={imageContainerRef} className="my-4 rounded-md overflow-hidden relative bg-muted w-full aspect-auto flex justify-center group">
              <Image src={annProp.media} alt={annProp.title} width={800} height={800} style={{width: 'auto', height: 'auto', maxHeight: '70vh'}} objectFit="contain" data-ai-hint="announcement media" />

...
export function useAnnouncements() {
  ...
  // Calculate unread count whenever announcements array changes.
  useEffect(() => {
  ...
  // A generic function to perform API actions and then refetch data.
  const performApiAction = useCallback(async (
    ...
    try {
      ...
      // CRITICAL STEP: Refetch data after a successful action.
